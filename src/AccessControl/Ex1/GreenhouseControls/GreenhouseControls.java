package AccessControl.Ex1.GreenhouseControls;
...
import AccessControl.Ex1.Controller.Controller;
import AccessControl.Ex1.Controller.Event;

public class GreenhouseControls extends Controller {
    private boolean light = false;

    public void addEvent(Bell bell) {
    }
    ...
    public class VentilationOn extends Event {
        ...
        public String toString() {
            return "Greenhouse ventilation is on";
        }
    }
    ...
    public class VentilationOff extends Event {
        ...
        public String toString() {
            return "Greenhouse ventilation is off";
        }
    }
